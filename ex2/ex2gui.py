...
class MagicSquareApp:
    def __init__(self, master):
        ...
        tk.Label(self.control_frame, text="Mutation rate:").grid(row=row_counter, column=0, sticky="w")
        self.mr_label = tk.Label(self.control_frame, text="0")
        self.mr_label.grid(row=row_counter, column=1, sticky="w")
        row_counter += 1


        tk.Label(self.control_frame, text="Best fitness:").grid(row=row_counter, column=0, sticky="w")
        self.bf_label = tk.Label(self.control_frame, text="0")
        self.bf_label.grid(row=row_counter, column=1, sticky="w")
        row_counter += 1
    ...
    def run_algorithm(self):
        try:
            ...
            while self.running:
                ...
                self.mr_label.config(text=str(ga.mutation_rate))
                ...
                self.bf_label.config(text=str(best_fitness))
